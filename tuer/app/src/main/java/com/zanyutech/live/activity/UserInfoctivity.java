                    ...
                    public void onClick(View view) {
                        ...
                        switch (point) {
                            ...
                            case 5://拉黑
                                ...
                                break;
                            case 6://举报
                                Intent intent = new Intent(mContext, WebViewActivity.class);//  http://www.tuerapp.com/h5/h5/help.html
                                intent.putExtra("webview_title", "举报");
                                intent.putExtra("webview_url", "http://www.tuerapp.com/h5/h5/report.html" + "?userId=" + MyApplication.getInstance().getUserId() + "&toUserId=" + InfoID);
                                startActivity(intent);
                                break;
                        }
                    }
...
//                }
            ...
            if (mMainModel.getCode().equals("1")) {
                if (mMainModel.getData() != null) {
                    ...
                    tuercodeTv.setText("兔耳号: " + userinfo.getTuId());
