...
//        main_wb.addJavascriptInterface(new WebAppInterface(context), "android");
        ...
        Log.e("loadUrl","token="+"http://www.tuerapp.com/h5/h5/eggs.html" + "?uid=" + MyApplication.getInstance().getUserId() + "&token=" + MyApplication.getInstance().getToken()+"&roomId="+Roomid);
        main_wb.loadUrl("http://www.tuerapp.com/h5/h5/eggs.html" + "?uid=" + MyApplication.getInstance().getUserId() + "&token=" + MyApplication.getInstance().getToken()+"&roomId="+Roomid);
